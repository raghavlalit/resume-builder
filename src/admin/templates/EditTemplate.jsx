...
import { getTemplateById, updateTemplate } from '../../utils/api';
import AdminLayout from '../AdminLayout';
import HtmlEditor from './HtmlEditor';

const EditTemplate = ({ breadcrumbs }) => {
  ...
  const fetchTemplate = async () => {
    try {
      ...
      setSnackbar({ open: true, message: 'Failed to fetch template', severity: 'error' });
    } finally {
      setFetching(false);
    }
  };
        ...
        <Paper sx={{ p: 4, borderRadius: 2, boxShadow: 3 }}>
          ...
          <Box sx={{ mb:4 }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Update the resume template with custom HTML and CSS styling
            </Typography>
          </Box>
